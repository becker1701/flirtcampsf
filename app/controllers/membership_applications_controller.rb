class MembershipApplicationsController < ApplicationController
  ...
  before_action :get_membership_app, only: [:edit, :approve, :decline, :thank_you, :archive]


  def index
    @membership_applications = MembershipApplication.where(archived: false).order(:created_at)
  end
...
#
  def membership_app_params
    params.require(:membership_application).permit(:name, :playa_name, :email, :phone, :home_town, :possibility, :contribution, :passions, :years_at_bm, :approved, :member_acquaintance)
  end
