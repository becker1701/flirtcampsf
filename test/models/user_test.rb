...
class UserTest < ActiveSupport::TestCase
  def setup 
  	@user = User.new(name: "Ray Ban", email: "ray@example.com", password: "foobar", password_confirmation: "foobar")
  end
  ...
  test "authenticate? returns false is remember_digest is nil" do
